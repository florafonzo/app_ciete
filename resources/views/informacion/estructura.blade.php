        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <img src="{{URL::to('/')}}/images/estructura.jpg" class="img-responsive">
                </div>
            </div>
            <div class="row">
                <div class="col-md-10 col-md-offset-1 parr_estruct1">
                    <h4 class="centro"> Directorio del CIETE </h4>
                    <p>
                    ...
                    <h4 class="centro">Unidad de asesoría</h4>
                    ...
                    <h4 class="centro">Unidad de formación</h4>
                    <p style="text-indent: 20px;">
                    ...
                    <h4 class="centro">Unidad de proyectos</h4>
                    <p style="text-indent: 20px;">
                    ...
                    <h4 class="centro">Unidad de producción</h4>
                    <p style="text-indent: 20px;">
                    ...
                    <h4 class="centro">Unidad de investigación</h4>
                    <p style="text-indent: 20px;">
                    ...
                    <h4 class="centro">Unidad de apoyo administrativo y técnico</h4>
                    <p style="text-indent: 20px;">
